...
// Menu (Ingreso, Retirada, Transferencia, Balance, List)
...
// Pide datos por consola & Verifica Datos
...
// Comprueba si existe la cuenta en la tabla
...
// Comprueba si tiene mas saldo de lo que se quiere retirar
...
// En la tabla "cuentas" aumenta el "saldo" & En la tabla "movimientos" se registra el "concepto"
...
// En la tabla "cuentas" disminuye el "saldo" & En la tabla "movimientos" se registra el "concepto"
...
// Muestra todas las entradas de la tabla "cuentas"
...
// En la tabla "movimientos" suma todos los "ingresos" y "retiradas" -> ("concepto")
// & los comprueba con el "saldo" de la tabla "cuentas"
